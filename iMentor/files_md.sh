...
declare -a IGNORE_DIRS=("node_modules" "assets" "backup_assets" "venv" ".git" ".vscode" "dist" "build") # Add folder names to ignore
declare -a INCLUDE_EXTENSIONS=("py" "js" "jsx" "ts" "tsx" "css" "scss" "html" "txt" "env"  "yml") # Add file extensions to include
...
tree -a -I 'node_modules|venv|.git|backup_assets|assets' $START_DIR --> o.txt
